...
public class BinaryTree<ContentType> {
    ...
    public BinaryTree(){
        //TODO 01a
        this.node = null;  //Eigentlich unnötig, da die node zu Beginn sowieso null ist.
    }
    ...
    public BinaryTree(ContentType pContent, BinaryTree<ContentType> pLeftTree, BinaryTree<ContentType> pRightTree){
        ...
        if (pContent != null){
            ...
            if (pLeftTree != null){
                ...
                node.left = new BinaryTree<ContentType>(); //Eigentlich unnötig, da eine neue Node bereits einen leeren linken Teilbaum erstellt.
            }
            if (pRightTree != null){
    ...
    public void setLeftTree(BinaryTree<ContentType> pTree){
        //TODO 01g
        if (pTree != null && !isEmpty()) node.left = pTree;
    }
    ...
    public void setRightTree(BinaryTree<ContentType> pTree){
        //TODO 01h
        if (pTree != null && !isEmpty()) node.right = pTree;
    }
